...
class _IntlOnboardingFr {
	...
	// Translations
	String get firstStep => 'Déposer vos requêtes de façon simple';
	String get secondStep => 'Suivre l’évolution de vos requêtes';
...
extension on _IntlFr {
	Map<String, dynamic> _buildFlatMap() {
		return <String, dynamic>{
			'onboarding.firstStep': 'Déposer vos requêtes de façon simple',
			'onboarding.secondStep': 'Suivre l’évolution de vos requêtes',
